...
export default function BookPage() {
  ...
  const { services, settings, appointments, addAppointment } = useSalonStore();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await addAppointment({
        ...
        time,
        status: "pending",
        screenshotName: publicUrl, // Save the actual URL instead of the filename
        screenshotData: filePreview,
        paymentMethod,
