...
export default function ServicesPage() {
  const { t } = useI18n();
  const { services, addService, updateService, deleteService, addToast } = useSalonStore();
  ...
  const serviceFormFields = (
    <div className="space-y-4">
      ...
      <div className="flex gap-3 pt-2">
        <button type="button" onClick={handleSave} className="flex items-center gap-2 bg-primary text-primary-foreground px-5 py-3 rounded-2xl font-bold hover:opacity-90 transition-opacity">
